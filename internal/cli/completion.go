...
_lit_completions() {
  ...
  local commands="init new ls show edit close open archive delete unarchive restore comment label parent children dep export sync doctor fsck backup recover bulk beads workspace hooks migrate quickstart completion help"
...
complete -c lit -n '__fish_use_subcommand' -a 'init new ls show edit close open archive delete unarchive restore comment label parent children dep export sync doctor fsck backup recover bulk beads workspace hooks migrate quickstart completion help'
